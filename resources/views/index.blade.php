...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Furni Free Bootstrap 5 Template for Furnitureshe and Interior Design Websites by Untree.co </title>
	</head>
			...
			<div class="hero">
				<div class="container">
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap hero-img-wrap_2002">
                                <img src="{{ asset('images/couch.png') }}" >
							</div>
						</div>
					</div>
				</div>
